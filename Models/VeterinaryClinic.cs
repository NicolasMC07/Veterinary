...
public class VeterinaryClinic
{
    ...
    {
        var dogToUpdate = VeterinaryClinic.Dogs.FirstOrDefault(e => e.Equals(dog));
    ...
    {
        var catToUpdate = VeterinaryClinic.Cats.FirstOrDefault(e => e.Equals(cat));
    ...
    public void DeleteDog(int id)
    {
        Console.WriteLine("Ingresa el id del perro a eliminar");
            ...
            var dogToDelete = Dogs.FirstOrDefault(e => e.Id.Equals(dog));
    ...
    public void DeleteCat(int id)
    {
        Console.WriteLine("Ingresa el id del gato a eliminar");
            ...
            var catToDelete = Cats.FirstOrDefault(e => e.Id.Equals(cat));
